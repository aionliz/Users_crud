...
# esta clase nos dará una instancia de conexión a nuestra base de datos
...
# cambiar el usuario y la contraseña según sea necesario
        connection = pymysql.connect(host='localhost',
                                     user='root',
                                     password='tazmania2316',#no te olvides de cambiar la contraseña
                                     db=db,
                                     charset='utf8mb4',
        ...
        with self.connection.cursor() as cursor:
            try:
                ...
                if query.lower().find("insert") >= 0:
                    ...
                    # Las consultas ACTUALIZAR y ELIMINAR no devolverán nada
                    self.connection.commit()
